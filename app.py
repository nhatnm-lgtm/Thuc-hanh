...
with tab3:
    ...
    if st.button("🚀 Thực hiện Dự báo Gian lận", type="primary"):
        ...
        with res_col2:
            st.markdown("##### 🧮 2. Kết quả Beneish M-Score truyền thống")
...
# ---------------------------------------------------------
st.markdown("---")
st.caption("© 2026 Financial Fraud Detection App | Xây dựng dựa trên 8 biến Beneish M-Score & Mô hình Logistic Regression.")
